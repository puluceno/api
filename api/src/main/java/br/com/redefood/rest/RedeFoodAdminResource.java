...
public class RedeFoodAdminResource extends HibernateMapper {
	...
	@Inject
	private AdminLoginResource adminLogin;
	...
	public String findPendingRestaurants(@HeaderParam("locale") String locale) {
	...
	public Response refusePendingRestaurant(@HeaderParam("locale") String locale,
	...
	public Response deletePendingRestaurant(@HeaderParam("locale") String locale,
			@PathParam("idRestaurant") Short idRestaurant) {
	...
	public Response manageSubsidiary(@HeaderParam("locale") String locale, @PathParam("idSubsidiary") Short idSubsidiary) {
		try {
			UserLogin userLogin = (UserLogin) em.createNamedQuery(Subsidiary.FIND_OWNER_LOGIN_BY_ID_SUBSIDIARY)
					.setParameter("idSubsidiary", idSubsidiary).setParameter("idProfile", Profile.OWNER)
					.getSingleResult();

			return adminLogin.doLogin(locale, userLogin);
