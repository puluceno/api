 ...
 * 
 */
public class OrderCanceledNotificator extends Notificator {
     ...
     */
    public OrderCanceledNotificator() {
	setTemplate("mailtemplates/ordercanceled.mailtemplate");
	...
	String conteudo = MessageFormat.format(template, emailData.get("subsidiaryUrl"), emailData.get("logo"),
		...
		emailData.get("reason"), emailData.get("orderNumber"), emailData.get("subsidiaryPhone"),
