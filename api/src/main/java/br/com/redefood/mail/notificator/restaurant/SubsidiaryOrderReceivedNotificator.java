 ...
 * 
 */
public class SubsidiaryOrderReceivedNotificator extends Notificator {
     ...
     */
    public SubsidiaryOrderReceivedNotificator() {
	setTemplate("mailtemplates/subsidiaryorderreceived.mailtemplate");
	...
	String conteudo = MessageFormat.format(template, emailData.get("subsidiaryUrl"), emailData.get("logo"),
		emailData.get("subsidiaryName"), emailData.get("facebook"), emailData.get("orderNumber"),
		emailData.get("orderMade"), emailData.get("userName"), emailData.get("orderData"),
		emailData.get("urlHelp"), emailData.get("contactEmail"), emailData.get("footerSlogan"));
	
	// cria a mensagem
	MessageNotificator notificacao = new MessageNotificator(emailData.get("subsidiaryEmail"));
