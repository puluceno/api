 ...
 * 
 */
public class DemoNotificator extends Notificator {
     ...
     */
    public DemoNotificator() {
	setTemplate("mailtemplates/demo.mailtemplate");
	...
	String conteudo = MessageFormat.format(template, emailData.get("subsidiaryUrl"), emailData.get("logo"),
		...
		emailData.get("demoUrl"), emailData.get("demoLogin"), emailData.get("demoPass"),
	...
	notificacao.setAssunto("[RedeFood] - Acesso à loja Demonstração");
