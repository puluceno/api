 ...
 * 
 */
public class SubsidiaryCommentReceivedNotificator extends Notificator {
     ...
     */
    public SubsidiaryCommentReceivedNotificator() {
	setTemplate("mailtemplates/ordercomment.mailtemplate");
	...
	notificacao.setAssunto("[" + emailData.get("subsidiaryName") + "] - Comentário atribuído ao pedido nº "
		+ emailData.get("orderNumber"));
