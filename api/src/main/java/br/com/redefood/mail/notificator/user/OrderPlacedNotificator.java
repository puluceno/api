 ...
 * 
 */
public class OrderPlacedNotificator extends Notificator {
     ...
     */
    public OrderPlacedNotificator() {
	setTemplate("mailtemplates/orderplaced.mailtemplate");
	...
	String conteudo = MessageFormat.format(template, emailData.get("subsidiaryUrl"), emailData.get("logo"),
		...
		emailData.get("userName"), emailData.get("orderMade"), emailData.get("orderData"),
