 ...
 * 
 */
public class NewUserNotificator extends Notificator {
     ...
     */
    public NewUserNotificator() {
	setTemplate("mailtemplates/newuser.mailtemplate");
	...
	notificacao.setAssunto("[" + emailData.get("subsidiaryName") + "] - Confirmação de cadastro");
