 ...
 * 
 */
public class UserCommentReceivedNotificator extends Notificator {
     ...
     */
    public UserCommentReceivedNotificator() {
	setTemplate("mailtemplates/userordercomment.mailtemplate");
	...
	notificacao.setAssunto("[" + emailData.get("subsidiaryName") + "] - Resposta atribuída ao pedido nº "
