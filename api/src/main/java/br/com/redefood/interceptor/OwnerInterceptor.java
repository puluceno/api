...
@ServerInterceptor
@RedirectPrecedence
public class OwnerInterceptor implements PreProcessInterceptor, AcceptedByMethod {
	...
	WebApplicationException {
		...
		Owner owner = method.getMethod().getAnnotation(Owner.class);
		...
		try {
			...
			if (!idProfile.equals(Profile.OWNER))
	...
	public boolean accept(Class clazz, Method method) {
		return method.isAnnotationPresent(Owner.class);
	}
}